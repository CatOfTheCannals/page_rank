	...
	\subsection{\textit{Page Rank} (ranking de Page/rango de página)}
		...
		\subsubsection{Eliminación Gaussiana \textit{(gaussian elimination)}}
			...
			\subsubsubsection{Implementación}
				...
				En un principio, implementamos y verificamos el funcionamiento de este método basándonos en una clase matriz previa más simple, implementada con un \textit{array}. \\
				...
				Lo que hicimos luego, fue programar los mismos métodos públicos en la nueva clase matriz dispersa, para poder utilizar el mismo el algoritmo de eliminación gaussiana, sin hacerle demasiados cambios. \\
