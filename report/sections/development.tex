...
% una breve explicación de los motivos de estas fallas (en caso de ser conocidas).
	...
	\subsection{Elección de la estructura de datos}
		...
		Esto nos hizo pensar que, para hacer estas operaciones, sería más fácil tener a la matriz como map \textit{de filas}. \\

		Entonces lo que resolvimos hacer fue cargar la matriz como map de columnas para armar el sistema, y luego traponerla e interpretarla como un map de filas para la resolución del sistema lineal. \\
